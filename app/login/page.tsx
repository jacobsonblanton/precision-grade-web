  ...
  return (
    <div className="min-h-screen bg-neutral-950 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        {/* Card */}
        <div className="bg-neutral-900/90 border border-neutral-700/60 rounded-2xl shadow-2xl shadow-black/40 overflow-hidden backdrop-blur-sm">
          {/* Top accent bar */}
          ...
          <div className="px-8 pt-8 pb-10">
            ...
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 font-medium">Field Operations Dashboard</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-neutral-950/80 border border-neutral-700/60 rounded-lg px-4 py-3 text-sm text-white placeholder-neutral-600 focus:outline-none focus:border-red-500/60 focus:ring-1 focus:ring-red-500/20 transition-colors"
                />
              </div>
            ...
            {/* Demo credentials */}
            <div className="mt-6 p-4 rounded-xl bg-neutral-950/60 border border-neutral-700/40">
              ...
              <div className="space-y-1.5 text-xs">
                <div className="flex justify-between">
                  ...
                  <span className="font-mono text-slate-300">trainer / trainer123</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-500">Sales (SE):</span>
                  <span className="font-mono text-slate-300">sales_se / sales123</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-500">Sales (MW):</span>
                  <span className="font-mono text-slate-300">sales_mw / sales123</span>
                </div>
              </div>
            </div>
          </div>
